...
Read the effective guidelines with `python scripts/kit.py guidelines <project> <page> --role ui`. That resolves global, base, project, and page layers in precedence order and omits the other roles' base files. Do not read `guidelines/` directly.
