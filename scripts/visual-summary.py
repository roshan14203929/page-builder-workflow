...
def main() -> int:
    ...
    summary = {
        ...
        "pixelDifferencePercent": max(float(report.get("pixelDifferencePercent", 100)) for report in reports),
        "peakBandDifferencePercent": max(float(report.get("peakBandDifferencePercent", 100)) for report in reports),
        "reports": reports,
    }
